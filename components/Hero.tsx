...
function Hero() {
  ...
  const headingContent = ["Full Stack ", "Developer ", "& Blockchain ", "Engineer"];
    ...
    >
      ...
      <div className=" flex flex-col items-end justify-between ">
        <div className="flex justify-end items-center gap-4 w-[100%] sm:w-[80%] md:w-[80%] lg:w-[50%]">
          ...
          >
            Hi, I'm William Greer. I'm a dedicated Full Stack and Blockchain Engineer with a passion for building seamless user experiences, crafting robust and efficient systems, and developing innovative solutions that bridge the gap between traditional applications and decentralized technologies.
          </motion.p>
        </div>
      </div>
    </motion.section>
